 ...
 * @hide
 */
public class LinkLossServiceClient extends BleClientService {

    public static String TAG = "LinkLossServiceClient";
    private static final String SERVICE_UUID = "00001803-0000-1000-8000-00805f9b34fb";
    static final String ALERT_LEVEL_CHARACTERISTIC_UUID = "00002a06-0000-1000-8000-00805f9b34fb";

    private ArrayList<UUID> mRequiredUuid = new ArrayList<UUID>();
    private int[] mCharInstanceID;
    private byte[] mAuthReq;

    public LinkLossServiceClient() {
        super(new BleGattID(SERVICE_UUID));

        Log.d(TAG, "LinkLossServiceClient");
        // following uuids are required
        // 0x2A06 - Alert Level
